...
public:
    ...
    */
    ...
    vector<vector <Cell> > C4Grid;

    void removeHorizontal(unsigned int r, unsigned int c);

    void removeVertical(unsigned int r, unsigned int c);

    void removeDiagonal(unsigned int r, unsigned int c);

    void removeDiagonalOp(unsigned int r, unsigned int c);
