...
public:
    ...
    */
    ...
    Player* checkHorizontal(unsigned int r, unsigned int c);

    Player* checkVertical(unsigned int r, unsigned int c);

    Player* checkDiagonal(unsigned int r, unsigned int c);

    Player* checkDiagonalOp(unsigned int r, unsigned int c);
